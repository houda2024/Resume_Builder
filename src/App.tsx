          ...
          <Routes>
            ...
            <Route element={<RequireAuth />}>
              <Route path="/page" element={<PageLayout />}>
                ...
                <Route path={`templates/stepper:gemheart`} element={<Stepper />} />
                <Route
                  path={`templates/stepper:gemheart/preview`}
                  element={<Preview />}
                  
                />
                <Route path={`templates/stepper:Adolfa`} element={<Stepper />} />
                <Route
                  path={`templates/stepper:Adolfa/preview`}
                  element={<Preview />}
                  />
                <Route path={`templates/stepper:Pixel`} element={<Stepper />} />
                <Route
                  path={`templates/stepper:Pixel/preview`}
                  element={<Preview />}
                  />
                <Route path={`templates/stepper:Empire`} element={<Stepper />} />
                <Route
                  path={`templates/stepper:Empire/preview`}
                  element={<Preview />}
                  />
