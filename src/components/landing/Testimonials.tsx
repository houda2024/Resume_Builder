        ...
        <div className="landing-card flex justify-center items-center shadow-sm md:mr-3">
          <div>
            ...
            <div className="text-center w-72">
              ...
              CVMastermind helped me land my first job after a very long while, they
                are amazing! an absolute saver.
              </h3>
              <p className="pt-4 text-base text-hero italic">- Ahmed</p>
            </div>
          </div>
        </div>
        <div className="landing-card flex justify-center items-center shadow-sm md:mr-3">
          <div>
            ...
            <div className="text-center w-72">
              ...
              <p className="pt-4 text-base text-hero italic">- Amira</p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="text-center w-72">
              <h3 className="font-semibold text-herotext text-base px-4 md:px-12 lg:px-0">
                I will forever be grateful to CVMastermind for helping me get my
